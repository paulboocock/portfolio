...
export default () => (
    <div className={cardsStyles.cards}>
        ...
        <Card title="Learner" subTitle="Always Reading" body="I believe we never stop learning and I'm always keens to pick up new skills and knowledge. I'm currently studying Data Science, Technology & Innovation MSc at The University of Edinburgh." photo="learner.jpg"/>
        ...
        <Card title="Data & Analytics" subTitle="Love Data" body="I relish helping organisations find meaning in their data. Experienced with Snowplow, Hotjar, Google Analytics and Looker. Frequent user of BigQuery, PostgreSQL and Cassandra." photo="data.jpg" alt="true" />
